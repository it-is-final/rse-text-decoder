...
import { languageToCharMapMap, languageToReverseCharMapMap, writableCharSetMap } from "./types";
...
const writableCharsGER: ReadonlySet<number> = new Set([
    ...
    0xE4, 0xE5, 0xE6, 0xE7, 0xE8,
    0xE9, 0xEA, 0xEB, 0xEC, 0xED, 
    0xEE, 0xF1, 0xF2, 0xF3, 0xF4, 
    0xF5, 0xF6, 0xFF,
]);

const rubyCharacterMaps: languageToCharMapMap = {
    "JPN": rubyMapJpn,
    "ENG": rubyMapEng,
    "FRA": rubyMapFra,
    "ITA": rubyMapIta,
...
const fireredCharacterMaps: languageToCharMapMap = {
    "JPN": fireredMapJpn,
    "ENG": fireredMapEng,
    "FRA": fireredMapFra,
    "ITA": fireredMapIta,
...
const emeraldCharacterMaps: languageToCharMapMap = {
    "JPN": emeraldMapJpn,
    "ENG": emeraldMapEng,
    "FRA": emeraldMapFra,
    "ITA": emeraldMapIta,
...
export const characterMaps = {
    "RS": rubyCharacterMaps,
    "FRLG": fireredCharacterMaps,
    "E": emeraldCharacterMaps,
}

const rubyCharacterMapsR: languageToReverseCharMapMap = {
    "JPN": rubyMapJpnR,
    "ENG": rubyMapEngR,
    "FRA": rubyMapFraR,
    "ITA": rubyMapEngR,
...
const fireredCharacterMapsR: languageToReverseCharMapMap = {
    "JPN": emeraldMapJpnR,
    "ENG": fireredMapEngR,
    "FRA": fireredMapFraR,
    "ITA": fireredMapEngR,
...
const emeraldCharacterMapsR: languageToReverseCharMapMap = {
    "JPN": emeraldMapJpnR,
    "ENG": emeraldMapEngR,
    "FRA": emeraldMapFraR,
    "ITA": emeraldMapEngR,
...
export const characterMapsR = {
    "RS": rubyCharacterMapsR,
    "FRLG": fireredCharacterMapsR,
    "E": emeraldCharacterMapsR,
}

export const writableCharSet: writableCharSetMap = {
