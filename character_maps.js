...
const englishCharacterMap = {
    0x0 : ' ',
    0x1 : 'À', 0x2 : 'Á', 0x3 : 'Â', 0x4 : 'Ç', 0x5 : 'È',
    0x6 : 'É', 0x7 : 'Ê', 0x8 : 'Ë', 0x9 : 'Ì', 0xa : 'こ',
    ...
    0x4b : 'ぱ', 0x4c : 'ぴ', 0x4d : 'ぷ', 0x4e : 'ぺ', 0x4f : 'ぽ',
    0x50 : '▯',
    0x51 : '¿', 0x52 : '¡', 0x53 : 'ウ', 0x54 : 'エ', 0x55 : 'オ',
    0x56 : 'カ', 0x57 : 'キ', 0x58 : 'ク', 0x59 : 'ケ', 0x5a : 'Í',
...
export function substituteChar (character, lang) {
    switch(lang) {
        case 'JP':
            switch (character) {
                case ' ':
...
export function getCharacterMap(lang) {
    let charMap;
    switch(lang) {
        case 'JP':
            charMap = japaneseCharacterMap; break;
        case 'EN':
            charMap = englishCharacterMap; break;
        case 'FR':
            charMap = frenchCharacterMap; break;
        case 'DE':
            charMap = germanCharacterMap; break;
        default:
            alert("undefined language");
            return null;
    }
    let reverseCharMap = {};
    for (let char of Object.entries(charMap)) {
        reverseCharMap[char[1]] = parseInt(char[0]);
    }
    return [charMap, reverseCharMap];
}